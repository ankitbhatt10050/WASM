...
// Option is enum and it can hold null or empty value
...
impl World{
   pub fn new(width:usize, snake_idx:usize)->World{
    ...
    // we cannot share reference type data cause the reference may loss
    // during execution but once wasm returned it to JS
    // we will still be using lost reference, 
    // TO OVERCOME THIS WE WILL SHARE MEMORY
    // pub fn snake_cells(&self)->&Vec<SnakeCell>{
    //     &self.snake.body
    // }


    // we are returning memory address i.e pointer
